...
public class Detail{
	...
	public Detail(String originalLanguage, String imdbId, boolean video, String title, String backdropPath, int revenue, List<GenresItem> genres, double popularity, List<ProductionCountriesItem> productionCountries, int id, int voteCount, int budget, String overview, String originalTitle, int runtime, String posterPath, List<SpokenLanguagesItem> spokenLanguages, List<ProductionCompaniesItem> productionCompanies) {
		this.originalLanguage = originalLanguage;
		this.imdbId = imdbId;
		this.video = video;
		this.title = title;
